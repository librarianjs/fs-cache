...
describe('CachePlugin', () => {
  ...
  before(function () {
    plugin = new CachePlugin({dir: '/tmp/librarian-cache'})
  })
  ...
  it('should get() successfully', () => {
    return plugin.get(TEST_KEY).then(fetched => {
      if (TEST_DATA.compare(fetched) !== 0) {
        throw new Error('Fetched data does not match')
      }
    })
  })
  ...
  it('should delete items after they have expired')
})
